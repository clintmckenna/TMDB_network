...
Looks a little whacky to start with. For one, if there are multiple edges between nodes, the plot with make a separate line for each edge. Instead, we want to convert this to a weighted edge (so thicker lines = more cooccurrences of the relationships).
